  ...
  Future<void> fetchProducts() async {
    ...
    try {
      ...
      final favUrl = Uri.parse(
          'https://virtual-shop-flutter-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authToken');
...
// changed the following function to return a future since we want a loading screen
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = Uri.parse(
          'https://virtual-shop-flutter-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken');
